    ...
    <div className="container py-5">
      <div className="content-section mx-auto">
        ...
        <ul>
          ...
          <li>
            Acceptance is based on peer reviewer recommendations and editorial
            decision.
          </li>
        ...
        <p className='fw-normal'>
          ...
          <a
            href="mailto:contact@brightsphereinsights.com"
        ...
        <h3>4. Manuscript Declaration</h3>
        <ul>
          <li>Manuscripts must be original and unpublished.</li>
          <li>Submissions must not be under consideration in another journal.</li>
          <li>
            All authors listed must meet authorship criteria and approve the final
            version.
          </li>
        </ul>
        ...
        <div className="sub-section">
          ...
          <ul>
            ...
            <li>
              Corresponding author’s contact details (email and postal address)
            </li>
          ...
          <ul>
            <li>Maximum 250 words</li>
            <li>
              For detailed guidance, refer to “A Guide for Biological and Medical
          ...
          <ul>
            ...
            <li>Line drawings: 800–1200 dpi</li>
          ...
          <ul>
            <li>
              ...
              identifiers must not be included.
            </li>
            <li>
              Animal studies must adhere to institutional or national ethical
              standards.
            </li>
          ...
          <ul>
            <li>
              <strong>Before Review: </strong>Authors can withdraw their submission
              anytime before the peer review process begins.
            </li>
            <li>
              <strong>During Review: </strong>Withdrawal is allowed with a valid
              reason, provided all authors agree.{" "}
            </li>
            <li>
              <strong>After Acceptance: </strong>Withdrawal is discouraged but may
