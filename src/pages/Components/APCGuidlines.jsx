...
export const APCGuidlines = () => {
  ...
  <div className="content-section mx-auto">
    ...
    <p className='fw-normal'>
      ...
      management, peer review, production, indexing, online hosting, and
      long-term archiving, an Article Processing Charge (APC) is applied to
    ...
    <ul className='ps-0' style={{listStyle:"none"}}>
      ...
      <li>
        The APC is payable only after the manuscript is accepted for
        publication, following peer review and editorial approval.
      </li>
      <li>
        Payment of APC ensures that the article is published open access and
        remains permanently available online.
      </li>
    </ul>
    ...
    <ul className='ps-0' style={{listStyle:"none"}}>
      ...
      <li>High-quality typesetting and PDF/HTML production</li>
      <li>DOI assignment and indexing in major databases</li>
    ...
    <ul className='ps-0' style={{listStyle:"none"}}>
      ...
      <li>
        Waivers are considered on a case-by-case basis and must be requested at
    ...
    <ul className='ps-0' style={{listStyle:"none"}}>
      ...
      <li>There are no hidden charges beyond the stated APC.</li>
      <li>
        The editorial decision to accept or reject a manuscript is never
        influenced by the ability to pay the APC.
      </li>
    </ul>
  </div>
</div>
